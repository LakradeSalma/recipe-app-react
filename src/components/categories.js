                    ...
                    {props.categories.map((category) => (
                        <div key={category.idCategory} className="card lg:basis-1/6 md:basis-1/4 sm:basis-1 m-2 bg-white border  rounded-lg shadow-md border-gray-700">
                            ...
                            <div className="p-5">
                                ...
                                <Link to={`/category/${category.strCategory}`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300  ">
                                    See more
